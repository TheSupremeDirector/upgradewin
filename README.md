...
Next we have Windows 1.0X. I used the Windows 1.04 OEM for IBM. This is because it has native suport for both PS/2 and VGA. Make sure to select a PS/2 Mouse (option 7), and then Model 50, 60, 80 (option 2). Select N when asked about a printer. https://github.com/TheSupremeDirector/upgradewin/tree/main/WINDOWS-1.04-IBM-OEM
